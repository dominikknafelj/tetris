...
// Scoring constants
const SCORE_SINGLE: u32 = 100;    // Points for clearing 1 line
const SCORE_DOUBLE: u32 = 300;    // Points for clearing 2 lines
const SCORE_TRIPLE: u32 = 500;    // Points for clearing 3 lines
const SCORE_TETRIS: u32 = 800;    // Points for clearing 4 lines
const SCORE_DROP: u32 = 1;        // Points per cell for dropping a piece
const MAX_HIGH_SCORES: usize = 10; // Maximum number of high scores to store
